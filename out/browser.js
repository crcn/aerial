...
var BaseSyntheticBrowser = (function (_super) {
    ...
    function BaseSyntheticBrowser(_kernel, renderer, parent) {
        ...
        _this.uid = sandbox_1.generateSyntheticUID();
        _kernel.inject(_this);
        _this.statusWatcher = new common_1.PropertyWatcher(_this, "status");
        _this.logs = common_1.ObservableCollection.create();
        _this._renderer = _kernel.inject(common_1.isMaster ? renderer || new renderers_1.SyntheticDOMRenderer() : new renderers_1.NoopRenderer());
        _this._renderer.observe(new mesh_1.CallbackDispatcher(_this.onRendererEvent.bind(_this)));
        _this._documentObserver = new mesh_1.CallbackDispatcher(_this.onDocumentEvent.bind(_this));
        _this._windowObserver = new mesh_1.CallbackDispatcher(_this.onWindowEvent.bind(_this));
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!common_1.hasURIProtocol(options2.uri))
...
var SyntheticBrowser = (function (_super) {
    ...
    SyntheticBrowser.prototype.$didInject = function () {
        ...
        this._sandbox = new sandbox_1.Sandbox(this._kernel, this.createSandboxGlobals.bind(this));
