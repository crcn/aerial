...
var SyntheticWindow = (function (_super) {
    ...
    function SyntheticWindow(location, browser, document) {
        ...
        var bus = kernel && common_1.PrivateBusProvider.getInstance(kernel) || mesh_1.noopDispatcherInstance;
        ...
        new common_1.PropertyWatcher(_this.location, "href").connect(function (newValue) {
            _this.notify(new events_1.SyntheticDOMEvent(events_1.DOMEventTypes.POP_STATE));
        });
        _this.window = _this;
        _this.console = new SyntheticConsole(new common_1.Logger(new mesh_1.CallbackDispatcher(_this.onVMLog.bind(_this))));
