...
var SyntheticDOMNode = (function (_super) {
    ...
    function SyntheticDOMNode(nodeName) {
        ...
        _this.regenerateUID();
        _this.metadata = new common_1.Metadata(_this.getInitialMetadata());
        _this.metadata.observe(new common_1.BubbleDispatcher(_this));
        return _this;
    }
    ...
    SyntheticDOMNode.prototype.contains = function (node) {
        return !!common_1.findTreeNode(this, function (child) { return child === node; });
    };
    /**
