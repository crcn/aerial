...
var SyntheticDOMComment = SyntheticDOMComment_1 = (function (_super) {
    __extends(SyntheticDOMComment, _super);
    function SyntheticDOMComment(nodeValue) {
...
SyntheticDOMComment = SyntheticDOMComment_1 = __decorate([
    common_1.serializable("SyntheticDOMComment", new node_1.SyntheticDOMNodeSerializer(new value_node_1.SyntheticDOMValueNodeSerializer()))
], SyntheticDOMComment);
