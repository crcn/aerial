...
var SyntheticDOMContainerEdit = (function (_super) {
    ...
    SyntheticDOMContainerEdit.prototype.addDiff = function (newContainer) {
        var _this = this;
        common_1.diffArray(this.target.childNodes, newContainer.childNodes, function (oldNode, newNode) {
...
var SyntheticDOMContainer = (function (_super) {
    ...
    SyntheticDOMContainer.prototype.getChildSyntheticByUID = function (uid) {
        return common_1.findTreeNode(this, function (child) { return child.uid === uid; });
    };
    ...
    SyntheticDOMContainer.prototype.getElementsByTagName = function (tagName) {
        return collections_1.SyntheticHTMLCollection.create.apply(collections_1.SyntheticHTMLCollection, common_1.filterTree(this, function (node) {
