...
var SyntheticCSSKeyframesRuleSerializer = (function () {
    ...
    SyntheticCSSKeyframesRuleSerializer.prototype.deserialize = function (_a, kernel) {
        var name = _a.name, cssRules = _a.cssRules;
        return new SyntheticCSSKeyframesRule(name, cssRules.map(function (cs) { return common_1.deserialize(cs, kernel); }));
    };
...
var SyntheticCSSKeyframesRule = SyntheticCSSKeyframesRule_1 = (function (_super) {
...
SyntheticCSSKeyframesRule = SyntheticCSSKeyframesRule_1 = __decorate([
    common_1.serializable("SyntheticCSSKeyframesRule", new base_1.SyntheticCSSObjectSerializer(new SyntheticCSSKeyframesRuleSerializer()))
