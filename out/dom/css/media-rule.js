...
var SyntheticCSSMediaRuleSerializer = (function () {
    ...
    SyntheticCSSMediaRuleSerializer.prototype.deserialize = function (_a, kernel) {
        var media = _a.media, cssRules = _a.cssRules;
        return new SyntheticCSSMediaRule(media, cssRules.map(function (cs) { return common_1.deserialize(cs, kernel); }));
    };
    return SyntheticCSSMediaRuleSerializer;
}());
var SyntheticCSSMediaRule = SyntheticCSSMediaRule_1 = (function (_super) {
...
SyntheticCSSMediaRule = SyntheticCSSMediaRule_1 = __decorate([
    common_1.serializable("SyntheticCSSMediaRule", new base_1.SyntheticCSSObjectSerializer(new SyntheticCSSMediaRuleSerializer()))
