...
var SyntheticCSSStyleGraphics = (function (_super) {
    ...
    function SyntheticCSSStyleGraphics(style) {
        ...
        _this.backgrounds = common_1.ObservableCollection.create();
        _this.boxShadows = common_1.ObservableCollection.create();
        _this.filters = common_1.ObservableCollection.create();
        _this.fontFamily = [];
    ...
    SyntheticCSSStyleGraphics.prototype.setProperty = function (name, value) {
        ...
        var handlers = {
            ...
            filter: function (value) { return _this.filters = common_1.ObservableCollection.create.apply(common_1.ObservableCollection, value); },
