...
var SyntheticCSSUnknownAtRuleSerializer = (function () {
    ...
    SyntheticCSSUnknownAtRuleSerializer.prototype.serialize = function (_a) {
        ...
        return [atRuleName, params, cssRules.map(common_1.serialize)];
    };
    SyntheticCSSUnknownAtRuleSerializer.prototype.deserialize = function (_a, kernel) {
        ...
        return new SyntheticCSSUnknownGroupAtRule(atRuleName, params, cssRules.map(function (cs) { return common_1.deserialize(cs, kernel); }));
    };
    return SyntheticCSSUnknownAtRuleSerializer;
}());
var SyntheticCSSUnknownGroupAtRule = SyntheticCSSUnknownGroupAtRule_1 = (function (_super) {
    __extends(SyntheticCSSUnknownGroupAtRule, _super);
    function SyntheticCSSUnknownGroupAtRule(atRuleName, params, cssRules) {
        if (cssRules === void 0) { cssRules = []; }
...
SyntheticCSSUnknownGroupAtRule = SyntheticCSSUnknownGroupAtRule_1 = __decorate([
    common_1.serializable("SyntheticCSSUnknownGroupAtRule", new base_1.SyntheticCSSObjectSerializer(new SyntheticCSSUnknownAtRuleSerializer()))
