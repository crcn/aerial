...
var SyntheticCSSFontFaceSerializer = (function () {
    ...
    SyntheticCSSFontFaceSerializer.prototype.serialize = function (_a) {
        var style = _a.style;
        return common_1.serialize(style);
    };
    SyntheticCSSFontFaceSerializer.prototype.deserialize = function (style, kernel) {
        return new SyntheticCSSFontFace(common_1.deserialize(style, kernel));
    };
    return SyntheticCSSFontFaceSerializer;
}());
var SyntheticCSSFontFace = SyntheticCSSFontFace_1 = (function (_super) {
    __extends(SyntheticCSSFontFace, _super);
    function SyntheticCSSFontFace(style) {
...
SyntheticCSSFontFace = SyntheticCSSFontFace_1 = __decorate([
    common_1.serializable("SyntheticCSSFontFace", new base_1.SyntheticCSSObjectSerializer(new SyntheticCSSFontFaceSerializer()))
