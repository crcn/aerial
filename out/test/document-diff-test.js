        ...
        it("properly diffs " + JSON.stringify(changes), function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        browser = _c.sent();
                        watcher = new sandbox_1.SyntheticObjectChangeWatcher(function (mutations) {
                            new sandbox_1.SyntheticObjectTreeEditor(clone).applyMutations(mutations.map(function (mutation) {
                                return common_1.deserialize(JSON.parse(JSON.stringify(common_1.serialize(mutation))), browser.kernel);
                            }));
                        }, function (c) {
                    ...
                    case 3:
                        ...
                        fileName = _a[_i];
                        return [4 /*yield*/, sandbox_1.URIProtocolProvider.lookup(fileName, browser.kernel).write(fileName, fileChanges[fileName])];
                    case 4:
                        _c.sent();
                        _c.label = 5;
                    case 5:
