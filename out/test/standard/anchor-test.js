...
describe(__filename + "#", function () {
    ...
    xit("anchor tags have a pathname property", function () { return __awaiter(_this, void 0, void 0, function () {
        var window;
    ...
    // note that this does not work yet.
    xit("can change any property of the anchor tag and see it reflected in the href", function () { return __awaiter(_this, void 0, void 0, function () {
        var window;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, test_1.loadTestBrowser({
