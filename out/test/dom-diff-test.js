...
describe(__filename + "#", function () {
    [
        ...
        ["<div></div><span></span>", "<span></span>", [__1.SyntheticDOMContainerMutationTypes.REMOVE_CHILD_NODE_EDIT, sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT]],
        ["<div />", "<div></div><span></span>", [__1.SyntheticDOMContainerMutationTypes.INSERT_CHILD_NODE_EDIT]],
        ["<span></span><div></div>", "<div></div><span></span>", [__1.SyntheticDOMContainerMutationTypes.MOVE_CHILD_NODE_EDIT, sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT, sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT]],
    ...
    it("diff & patch a set or random HTML elements", function () {
        for (var i = 50; i--;) {
            ...
            a.appendChild(helpers_1.generateRandomSyntheticHTMLElement(document_1, 8, 4, 5));
            b.appendChild(helpers_1.generateRandomSyntheticHTMLElement(document_1, 8, 4, 5));
    ...
    it("patches the source of each synthetic object", function () {
        for (var i = 10; i--;) {
            ...
            a.appendChild(helpers_1.generateRandomSyntheticHTMLElement(document_2, 8, 4, 5));
            b.appendChild(helpers_1.generateRandomSyntheticHTMLElement(document_2, 8, 4, 5));
            a.createEdit().fromDiff(b).applyMutationsTo(a);
