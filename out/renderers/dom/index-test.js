...
describe(__filename + "#", function () {
    ...
    var fuzzyCSSCases = Array.from({ length: 10 }).map(function (v) { return [removeExtraWhitespace(helpers_1.generateRandomStyleSheet(4).cssText), ""]; });
    var fuzzyHTMLCases = Array.from({ length: 10 }).map(function (v) { return ["", helpers_1.generateRandomSyntheticHTMLElementSource(5, 5, 2)]; });
    [
        // basic rendering
        [["", "<div>hello</div>"]],
        [["", "<div a=\"b\">hello</div>"]],
