...
var common_2 = require("@tandem/common");
...
var BaseRenderer = (function (_super) {
    ...
    function BaseRenderer(nodeFactory) {
        ...
        _this.rectsWatcher = new common_2.PropertyWatcher(_this, "rects");
        ...
        _this._targetObserver = new mesh_1.CallbackDispatcher(_this.onDocumentEvent.bind(_this));
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, common_2.waitForPropertyChange(this, "_running", function (value) { return !!value; })];
                    case 1:
                        _a.sent();
                        _a.label = 2;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, common_2.waitForPropertyChange(this, "_rendered", function (value) { return !!value; })];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/];
...
var BaseDecoratorRenderer = (function (_super) {
    ...
    function BaseDecoratorRenderer(_renderer) {
        ...
        _renderer.observe(new mesh_1.CallbackDispatcher(_this.onTargetRendererEvent.bind(_this)));
        return _this;
    }
