...
export class SyntheticCSSStyle implements ISyntheticObject {
  ...
  public webkitBoundsAlign: string | null;
  public webkitBoundsDirection: string | null;
  public webkitBoundsFlex: string | null;
  public webkitBoundsOrdinalGroup: string | null;
  public webkitBoundsOrient: string | null;
  public webkitBoundsPack: string | null;
  public webkitBoundsSizing: string | null;
