...
var BaseSyntheticBrowser = (function (_super) {
    ...
    function BaseSyntheticBrowser(_kernel, renderer, parent) {
        ...
        _this.logs = new aerial_common_1.ObservableCollection();
        ...
        _this._renderer.observe(new mesh7_1.CallbackBus(_this.onRendererEvent.bind(_this)));
        _this._documentObserver = new mesh7_1.CallbackBus(_this.onDocumentEvent.bind(_this));
        _this._windowObserver = new mesh7_1.CallbackBus(_this.onWindowEvent.bind(_this));
        return _this;
    }
