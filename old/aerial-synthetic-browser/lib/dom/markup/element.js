...
var SyntheticDOMAttribute = (function (_super) {
    ...
    SyntheticDOMAttribute_1 = SyntheticDOMAttribute;
...
var SyntheticDOMElement = (function (_super) {
    ...
    function SyntheticDOMElement(namespaceURI, tagName) {
        ...
        _this.attributes = new SyntheticDOMAttributes();
        _this.attributes.observe(new mesh7_1.CallbackBus(_this.onAttributesEvent.bind(_this)));
        // todo - proxy this
        _this.dataset = {};
        return _this;
    }
