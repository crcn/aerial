...
var SyntheticDOMContainer = (function (_super) {
    ...
    SyntheticDOMContainer.prototype.getElementsByTagName = function (tagName) {
        return new (collections_1.SyntheticHTMLCollection.bind.apply(collections_1.SyntheticHTMLCollection, [void 0].concat(aerial_common_1.filterTree(this, function (node) {
    ...
    SyntheticDOMContainer.prototype.getElementsByClassName = function (className) {
        return new (collections_1.SyntheticHTMLCollection.bind.apply(collections_1.SyntheticHTMLCollection, [void 0].concat(this.querySelectorAll("." + className))))();
    };
