...
var SyntheticDOMValueNodeEdit = (function (_super) {
    ...
    SyntheticDOMValueNodeEdit.prototype.setValueNode = function (nodeValue) {
        return this.addChange(new aerial_common_1.SetValueMutation(SyntheticDOMValueNodeMutationTypes.SET_VALUE_NODE_EDIT, this.target, nodeValue));
    };
...
var SyntheticDOMValueNode = (function (_super) {
    ...
    Object.defineProperty(SyntheticDOMValueNode.prototype, "nodeValue", {
        ...
        set: function (value) {
            ...
            this.notify(new aerial_common_1.PropertyMutation(SyntheticDOMValueNodeMutationTypes.SET_VALUE_NODE_EDIT, this, "nodeValue", value).toEvent(true));
        },
        enumerable: true,
        configurable: true
    });
    ...
    SyntheticDOMValueNode.prototype.createEditor = function () {
        return new aerial_sandbox_1.GroupEditor(new DOMValueNodeEditor(this), _super.prototype.createEditor.call(this));
    };
