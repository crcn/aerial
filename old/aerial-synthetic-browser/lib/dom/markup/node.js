...
var SyntheticDOMNode = (function (_super) {
    ...
    SyntheticDOMNode.prototype.addEventListener = function (type, listener, capture) {
        this.eventDispatcher.add(type, listener);
    };
    SyntheticDOMNode.prototype.removeEventListener = function (type, listener, capture) {
