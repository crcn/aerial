...
var SyntheticCSSStyleGraphics = (function (_super) {
    ...
    SyntheticCSSStyleGraphics.prototype.setProperty = function (name, value) {
        ...
        var handlers = {
            ...
            filter: function (value) { return _this.filters = new (aerial_common_1.ObservableCollection.bind.apply(aerial_common_1.ObservableCollection, [void 0].concat(value)))(); },
