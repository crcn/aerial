...
var SyntheticCSSStyleRule = (function (_super) {
    ...
    Object.defineProperty(SyntheticCSSStyleRule.prototype, "metadata", {
        get: function () {
            ...
            this._metadata.observe(this._metadataObserver = new mesh7_1.CallbackBus(this._onMetadataEvent.bind(this)));
            return this._metadata;
        },
        enumerable: true,
        configurable: true
...
var SyntheticCSSElementStyleRule = (function (_super) {
    ...
    SyntheticCSSElementStyleRule_1 = SyntheticCSSElementStyleRule;
    ...
    SyntheticCSSElementStyleRule.prototype.matchesElement = function (element) {
        return selector_1.getSelectorTester(this.selector, element).test(element);
    };
