...
var SyntheticCSSStyleSheetSerializer = (function () {
    ...
    SyntheticCSSStyleSheetSerializer.prototype.serialize = function (value) {
        return {
            rules: value.rules.map(aerial_common_1.serialize)
        };
    };
    SyntheticCSSStyleSheetSerializer.prototype.deserialize = function (value, kernel) {
        return new SyntheticCSSStyleSheet(value.rules.map(function (raw) { return aerial_common_1.deserialize(raw, kernel); }));
    };
...
var SyntheticCSSStyleSheet = (function (_super) {
    ...
    SyntheticCSSStyleSheet_1 = SyntheticCSSStyleSheet;
    ...
    Object.defineProperty(SyntheticCSSStyleSheet.prototype, "cssText", {
        ...
        set: function (value) {
            ...
            this
                .createEdit()
                .fromDiff(evaluate_1.evaluateCSSSource(value))
    ...
    SyntheticCSSStyleSheet = SyntheticCSSStyleSheet_1 = __decorate([
        aerial_common_1.serializable("SyntheticCSSStyleSheet", new base_1.SyntheticCSSObjectSerializer(new SyntheticCSSStyleSheetSerializer()))
