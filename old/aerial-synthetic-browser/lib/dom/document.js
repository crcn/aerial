...
var SyntheticDocument = (function (_super) {
    ...
    function SyntheticDocument(defaultNamespaceURI, implementation) {
        ...
        _this.styleSheets = new aerial_common_1.ObservableCollection();
        _this.styleSheets.observe(new mesh7_1.CallbackBus(_this.onStyleSheetsEvent.bind(_this)));
        _this.$registeredElements = {};
        return _this;
    }
    SyntheticDocument_1 = SyntheticDocument;
