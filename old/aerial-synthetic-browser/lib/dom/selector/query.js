...
var SyntheticElementQuerier = (function (_super) {
    ...
    function SyntheticElementQuerier(target, selector, filter) {
        ...
        _this._rootObserver = new mesh7_1.CallbackBus(_this.onRootEvent.bind(_this));
        return _this;
    }
...
var ChildElementQuerier = (function (_super) {
    ...
    function ChildElementQuerier(parent, selector, filter) {
        ...
        _this.parentWatcher.connect(function (parent) {
            ...
            _this._parentWatchers = new aerial_common_1.DisposableCollection(targetWatcher.connect(function (target) { return _this.target = target; }).trigger(), queriedElementsWatcher.connect(_this.reset.bind(_this)));
        });
        return _this;
    }
