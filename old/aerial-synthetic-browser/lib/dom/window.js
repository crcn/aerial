...
var SyntheticWindow = (function (_super) {
    ...
    function SyntheticWindow(location, browser, document) {
        ...
        var bus = kernel && aerial_common_2.PrivateBusProvider.getInstance(kernel) || mesh7_1.noopBusInstance;
        ...
        _this.window = _this;
        _this.console = new SyntheticConsole(new aerial_common_2.Logger(new mesh7_1.CallbackBus(_this.onVMLog.bind(_this))));
