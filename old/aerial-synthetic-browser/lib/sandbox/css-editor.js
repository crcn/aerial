...
var CSSEditor = (function (_super) {
    ...
    CSSEditor.prototype[css_1.SyntheticCSSElementStyleRuleMutationTypes.SET_RULE_SELECTOR] = function (node, _a) {
        var target = _a.target, newValue = _a.newValue;
        var source = target.source;
        node.selector = newValue;
    };
    CSSEditor.prototype[css_1.CSSGroupingRuleMutationTypes.REMOVE_RULE_EDIT] = function (node, _a) {
        var target = _a.target, child = _a.child;
        var childNode = this.findTargetASTNode(node, child);
        childNode.parent.removeChild(childNode);
    };
    CSSEditor.prototype[css_1.CSSGroupingRuleMutationTypes.MOVE_RULE_EDIT] = function (node, _a) {
    ...
    CSSEditor.prototype[css_1.CSSGroupingRuleMutationTypes.INSERT_RULE_EDIT] = function (node, _a) {
        var target = _a.target, child = _a.child, index = _a.index;
        var newChild = child;
        var newChildNode = {
            rule: function (rule) {
    ...
    CSSEditor.prototype[css_1.SyntheticCSSElementStyleRuleMutationTypes.SET_DECLARATION] = function (node, _a) {
    ...
    CSSEditor.prototype.parseContent = function (content) {
        return css_1.parseCSS(content, undefined, null, false);
    };
