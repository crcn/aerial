...
describe(__filename + "#", function () {
    ...
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            kernel = test_1.createTestKernel({
                log: {
                    level: aerial_common_1.LogLevel.ERROR,
                },
                sandboxOptions: {
                    mockFiles: {}
                }
    ...
    var loadHTML = function (source) { return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
        var entryFilePath, protocol, browser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    entryFilePath = test_1.createRandomFileName("html");
                    protocol = aerial_sandbox_1.URIProtocolProvider.lookup(entryFilePath, kernel);
    ...
    [
        ...
        it("Can apply file edits from " + oldSource + " to " + newSource, function () { return __awaiter(_this, void 0, void 0, function () {
            var oldResult, newResult, edit, element, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        element = oldResult.documentElement.clone(true);
                        edit.applyMutationsTo(element);
                        return [4 /*yield*/, aerial_sandbox_1.FileEditorProvider.getInstance(kernel).applyMutations(edit.mutations)];
                    case 3:
                        _b.sent();
                        _a = chai_1.expect;
