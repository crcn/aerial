            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        loadableTagNames = this._kernel.queryAll(providers_1.LoadableElementProvider.getId("**")).map(function (provider) { return provider.tagName; });
                        ...
                        map = function (expression) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_j) {
                                switch (_j.label) {
                                    case 0:
                                        location = dom_1.getHTMLASTNodeLocation(expression) || { line: 1, column: 1 };
                                    ...
                                    case 6:
                                        ...
                                        textMimeType = providers_1.ElementTextContentMimeTypeProvider.lookup(expression, self._kernel);
                                        ...
                                        firstChildLocation = dom_1.getHTMLASTNodeLocation(firstChild);
                                    ...
                                    case 9:
                                        ...
                                        _j.label = 10;
                                    case 10:
                                        if (dom_1.HTML_VOID_ELEMENTS.indexOf(nodeName.toLowerCase()) === -1) {
