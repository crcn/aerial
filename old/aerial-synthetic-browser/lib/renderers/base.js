...
var BaseRenderer = (function (_super) {
    ...
    function BaseRenderer(nodeFactory) {
        ...
        _this._targetObserver = new mesh7_1.CallbackBus(_this.onDocumentEvent.bind(_this));
        return _this;
    }
...
var BaseDecoratorRenderer = (function (_super) {
    ...
    function BaseDecoratorRenderer(_renderer) {
        ...
        _renderer.observe(new mesh7_1.CallbackBus(_this.onTargetRendererEvent.bind(_this)));
        return _this;
    }
