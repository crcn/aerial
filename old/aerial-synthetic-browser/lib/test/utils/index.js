...
var aerial_commonjs_extension_1 = require("aerial-commonjs-extension");
...
exports.omit$$idDeep = function (obj) {
    if (Array.isArray(obj)) {
        return obj.map(exports.omit$$idDeep);
    }
    else if (obj && obj.constructor === Object || obj.constructor === aerial_common2_1.ImmutableObject) {
        var clone = {};
        for (var k in obj) {
            if (k === "$$id")
                continue;
            clone[k] = exports.omit$$idDeep(obj[k]);
        }
        return clone;
    }
    return obj;
};
exports.createRandomFileName = function (extension) { return Math.round(Math.random() * 9999999999) + "." + extension; };
exports.createTestKernel = function (options) {
    if (options === void 0) { options = {}; }
    var bus = new aerial_common_1.BrokerBus();
    var kernel = new aerial_common_1.Kernel(new aerial_common_1.KernelProvider(), test_1.createTestSandboxProviders(options.sandboxOptions), new aerial_common_1.PrivateBusProvider(bus), __1.createSyntheticHTMLProviders(), aerial_commonjs_extension_1.createJavaScriptSandboxProviders());
...
exports.loadTestBrowser = function (mockFiles, entryFilePath) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                kernel = exports.createTestKernel({
                    log: {
                        level: aerial_common_1.LogLevel.VERBOSE
                    },
                    sandboxOptions: {
                        mockFiles: mockFiles
                    }
