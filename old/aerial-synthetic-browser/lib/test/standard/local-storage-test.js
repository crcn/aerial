...
describe(__filename + "#", function () {
    it("Returns null if getItem doesn't exist", function () { return __awaiter(_this, void 0, void 0, function () {
        var window;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    chai_1.expect(window.document.querySelector("span").textContent).to.contain("true");
                    return [2 /*return*/];
            }
        });
    }); });
