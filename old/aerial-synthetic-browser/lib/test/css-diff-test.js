...
describe(__filename + "#", function () {
    ...
    [
        // style rule edits
        [".a { color: red }", ".a { color: blue }", [aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT, __1.SyntheticCSSElementStyleRuleMutationTypes.SET_DECLARATION]],
        // style sheet edits
        [".a {}", ".b {}", [__1.CSSGroupingRuleMutationTypes.REMOVE_RULE_EDIT, __1.CSSGroupingRuleMutationTypes.INSERT_RULE_EDIT]],
        [".a {}", ".b {} .a {}", [__1.CSSGroupingRuleMutationTypes.INSERT_RULE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT]],
        [".a {} .b {}", ".b {}", [__1.CSSGroupingRuleMutationTypes.REMOVE_RULE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT]],
        [".a {} .b {}", ".b {} .a {}", [__1.CSSGroupingRuleMutationTypes.MOVE_RULE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT]],
        [".a {} .b {}", ".a {} .c {} .b {}", [__1.CSSGroupingRuleMutationTypes.INSERT_RULE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT]],
        [".a {} .b {}", ".b {} .c {} .a {}", [__1.CSSGroupingRuleMutationTypes.MOVE_RULE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT, __1.CSSGroupingRuleMutationTypes.INSERT_RULE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT]],
        ["*[class*=\"col-\"] { padding: 10px; }", "*[class*=\"col-\"] { padding: 8px; }", [aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT, __1.SyntheticCSSElementStyleRuleMutationTypes.SET_DECLARATION]],
        // media query edits
        ...
        ["@media a { .a { color: red } }", "@media b { .a { color: red } } @media a { .a { color: red } }", [__1.CSSGroupingRuleMutationTypes.INSERT_RULE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT]],
        ...
        ["@keyframes a { 0% { color: red; }}", "@keyframes a { 0% { color: blue; }}", [aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT, aerial_sandbox_1.SyntheticObjectChangeTypes.SET_SYNTHETIC_SOURCE_EDIT, __1.SyntheticCSSElementStyleRuleMutationTypes.SET_DECLARATION]],
        // failed fuzzy tests
    ...
    it("can diff & patch random CSS style sheets", function () {
        var prev;
        for (var i = 100; i--;) {
            var curr = test_1.generateRandomStyleSheet(10, 5);
            if (!prev) {
                prev = curr;
                continue;
            }
    ...
    it("patches the source of each synthetic object", function () {
        var a = test_1.generateRandomStyleSheet(10, 5);
        var b = test_1.generateRandomStyleSheet(10, 5);
