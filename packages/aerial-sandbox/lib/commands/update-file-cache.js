...
var UpdateFileCacheCommand = (function (_super) {
    ...
    function UpdateFileCacheCommand() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    UpdateFileCacheCommand.prototype.execute = function (_a) {
        var uri = _a.uri, content = _a.content, updatedAt = _a.updatedAt;
        return __awaiter(this, void 0, void 0, function () {
            var item;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._fileCache.find(uri)];
                    case 1:
                        item = _a.sent();
                        if (!item)
                            return [2 /*return*/];
                        this.logger.info("Updating file cache: " + uri + ", mtime: " + updatedAt);
                        if (!(content == null)) return [3 /*break*/, 2];
                        item.contentUri = item.sourceUri;
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, item.setDataUrlContent(content)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
...
], UpdateFileCacheCommand.prototype, "_fileCache", void 0);
exports.UpdateFileCacheCommand = UpdateFileCacheCommand;
//# sourceMappingURL=update-file-cache.js.map