...
var calculateSyntheticBoundingRect = function (style) {
    ...
    return new aerial_common_1.BoundingRect(lp, tp, rp, bp);
};
    ...
    SyntheticDOMRenderer.prototype.updateRects = function () {
        ...
        for (var uid in this._elementDictionary) {
            ...
            if (syntheticNode && syntheticNode.nodeType === dom_2.DOMNodeType.ELEMENT) {
                ...
                var rect = typeof window !== "undefined" && window["$synthetic"] ? calculateSyntheticBoundingRect(nativeStyle) : aerial_common_1.BoundingRect.fromClientRect(native.getBoundingClientRect());
