...
var SyntheticDOMAttribute = (function (_super) {
    __extends(SyntheticDOMAttribute, _super);
    var SyntheticDOMAttribute = SyntheticDOMAttribute_1 = function SyntheticDOMAttribute(name, value, readonly) {
    ...
    SyntheticDOMAttribute = SyntheticDOMAttribute_1 = __decorate([
        aerial_common_1.serializable("SyntheticDOMAttribute", new SyntheticDOMAttributeSerializer())
...
}(aerial_common_1.ObservableCollection));
...
var SyntheticDOMElementSerializer = (function () {
    ...
    SyntheticDOMElementSerializer.prototype.serialize = function (_a) {
        ...
        return {
            ...
            shadowRoot: aerial_common_1.serialize(shadowRoot),
            attributes: [].concat(attributes).map(aerial_common_1.serialize),
            childNodes: [].concat(childNodes).map(aerial_common_1.serialize)
        };
    };
    SyntheticDOMElementSerializer.prototype.deserialize = function (_a, kernel, ctor) {
        ...
        for (var i = 0, n = attributes.length; i < n; i++) {
            element.attributes.push(aerial_common_1.deserialize(attributes[i], kernel));
        }
        for (var i = 0, n = childNodes.length; i < n; i++) {
            var child = aerial_common_1.deserialize(childNodes[i], kernel);
            element.appendChild(child);
        }
        var shadowRootFragment = aerial_common_1.deserialize(shadowRoot, kernel);
...
var SyntheticDOMElementEdit = (function (_super) {
    ...
    SyntheticDOMElementEdit.prototype.setAttribute = function (name, value, oldName, index) {
        return this.addChange(new aerial_common_1.PropertyMutation(SyntheticDOMElementMutationTypes.SET_ELEMENT_ATTRIBUTE_EDIT, this.target, name, value, undefined, oldName, index));
    };
    ...
    SyntheticDOMElementEdit.prototype.attachShadowRoot = function (shadowRoot) {
        this.addChange(new aerial_common_1.InsertChildMutation(SyntheticDOMElementMutationTypes.ATTACH_SHADOW_ROOT_EDIT, this.target, shadowRoot, Number.MAX_SAFE_INTEGER));
    };
    /**
    ...
    SyntheticDOMElementEdit.prototype.addDiff = function (newElement) {
        ...
        aerial_common_1.diffArray(this.target.attributes, newElement.attributes, function (a, b) { return a.name === b.name ? 1 : -1; }).accept({
...
var SyntheticDOMElement = (function (_super) {
    ...
    function SyntheticDOMElement(namespaceURI, tagName) {
        ...
        _this._shadowRootObserver = new aerial_common_1.BubbleDispatcher(_this);
        _this.attributes = SyntheticDOMAttributes.create();
        _this.attributes.observe(new mesh_1.CallbackBus(_this.onAttributesEvent.bind(_this)));
        // todo - proxy this
        _this.dataset = {};
        return _this;
    }
    ...
    SyntheticDOMElement.prototype.$setShadowRoot = function (shadowRoot) {
        ...
        this._shadowRoot.observe(new aerial_common_1.BubbleDispatcher(this));
        return this._shadowRoot;
    };
    ...
    SyntheticDOMElement.prototype.onAttributesEvent = function (_a) {
        ...
        else if (mutation.type === aerial_common_1.PropertyMutation.PROPERTY_CHANGE && mutation.target instanceof SyntheticDOMAttribute) {
    ...
    SyntheticDOMElement.prototype.attributeChangedCallback = function (name, oldValue, newValue) {
        this.notify(new aerial_common_1.PropertyMutation(SyntheticDOMElementMutationTypes.SET_ELEMENT_ATTRIBUTE_EDIT, this, name, newValue, oldValue).toEvent(true));
    };
    ...
    SyntheticDOMElement = __decorate([
        aerial_common_1.serializable("SyntheticDOMElement", new node_1.SyntheticDOMNodeSerializer(new SyntheticDOMElementSerializer()))
    ], SyntheticDOMElement);
