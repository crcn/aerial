...
var SyntheticDocumentFragmentSerializer = (function () {
    ...
    SyntheticDocumentFragmentSerializer.prototype.serialize = function (_a) {
        ...
        return childNodes.map(aerial_common_1.serialize);
    };
    SyntheticDocumentFragmentSerializer.prototype.deserialize = function (childNodes, kernel) {
        ...
        for (var i = 0, n = childNodes.length; i < n; i++) {
            fragment.appendChild(aerial_common_1.deserialize(childNodes[i], kernel));
        }
        return fragment;
    };
    return SyntheticDocumentFragmentSerializer;
}());
var SyntheticDocumentFragment = (function (_super) {
    __extends(SyntheticDocumentFragment, _super);
    var SyntheticDocumentFragment = SyntheticDocumentFragment_1 = function SyntheticDocumentFragment() {
    ...
    SyntheticDocumentFragment = SyntheticDocumentFragment_1 = __decorate([
        aerial_common_1.serializable("SyntheticDocumentFragment", new SyntheticDocumentFragmentSerializer())
