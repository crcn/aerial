...
var SyntheticCSSStyle = (function () {
    var SyntheticCSSStyle = SyntheticCSSStyle_1 = function SyntheticCSSStyle() {
        this.$source = null;
    ...
    SyntheticCSSStyle.prototype.clone = function () {
        return aerial_common_1.deserialize(aerial_common_1.serialize(this), null);
    };
    ...
    SyntheticCSSStyle.prototype.setProperty = function (name, newValue, priority, oldName, notifyOwnerNode) {
        ...
        if (ownerNode) {
            ownerNode.notify(new aerial_common_1.PropertyMutation(style_rule_1.SyntheticCSSElementStyleRuleMutationTypes.SET_DECLARATION, this.$parentRule, name, newValue, undefined, oldName).toEvent(true));
        }
    };
    ...
    SyntheticCSSStyle = SyntheticCSSStyle_1 = __decorate([
        aerial_common_1.serializable("SyntheticCSSStyle", {
