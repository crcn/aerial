...
var SyntheticCSSGroupingRuleEdit = (function (_super) {
    ...
    SyntheticCSSGroupingRuleEdit.prototype.insertRule = function (rule, index) {
        return this.addChange(new aerial_common_1.InsertChildMutation(CSSGroupingRuleMutationTypes.INSERT_RULE_EDIT, this.target, rule.clone(true), index));
    };
    SyntheticCSSGroupingRuleEdit.prototype.moveRule = function (rule, index, patchedOldIndex) {
        return this.addChange(new aerial_common_1.MoveChildMutation(CSSGroupingRuleMutationTypes.MOVE_RULE_EDIT, this.target, rule.clone(true), patchedOldIndex || this.target.rules.indexOf(rule), index));
    };
    SyntheticCSSGroupingRuleEdit.prototype.removeRule = function (rule) {
        return this.addChange(new aerial_common_1.RemoveChildMutation(CSSGroupingRuleMutationTypes.REMOVE_RULE_EDIT, this.target, rule, this.target.rules.indexOf(rule)));
    };
...
var SyntheticCSSGroupingRule = (function (_super) {
    ...
    SyntheticCSSGroupingRule.prototype.deleteRule = function (index) {
        ...
        if (owner)
            owner.notify(new aerial_common_1.RemoveChildMutation(CSSGroupingRuleMutationTypes.REMOVE_RULE_EDIT, this, rule, index).toEvent());
    };
    ...
    SyntheticCSSGroupingRule.prototype.insertRule = function (rule, index) {
        ...
        var owner = this.ownerNode;
        if (owner)
            owner.notify(new aerial_common_1.InsertChildMutation(CSSGroupingRuleMutationTypes.INSERT_RULE_EDIT, this, ruleInstance, index).toEvent());
        return index;
    };
