...
var BaseElementQuerier = (function (_super) {
    ...
    function BaseElementQuerier(target, selector, filter) {
        ...
        _this.targetWatcher = new aerial_common_1.PropertyWatcher(_this, "target");
        _this.filterWatcher = new aerial_common_1.PropertyWatcher(_this, "target");
        _this.selectorWatcher = new aerial_common_1.PropertyWatcher(_this, "target");
        _this.queriedElementsWatcher = new aerial_common_1.PropertyWatcher(_this, "queriedElements");
    ...
    BaseElementQuerier.prototype.setQueriedElements = function (newQueriedElements) {
        ...
        this.notify(new aerial_common_1.PropertyMutation(aerial_common_1.PropertyMutation.PROPERTY_CHANGE, this, "queriedElements", this._queriedElements = newQueriedElements, oldQueriedElements).toEvent());
    };
...
var SyntheticElementQuerier = (function (_super) {
    ...
    function SyntheticElementQuerier(target, selector, filter) {
        ...
        _this._rootObserver = new mesh_1.CallbackBus(_this.onRootEvent.bind(_this));
        return _this;
    }
...
var ChildElementQuerier = (function (_super) {
    ...
    function ChildElementQuerier(parent, selector, filter) {
        ...
        _this.parentWatcher = new aerial_common_1.PropertyWatcher(_this, "parent");
        _this.parentWatcher.connect(function (parent) {
            ...
            _this._parentWatchers = aerial_common_1.DisposableCollection.create(targetWatcher.connect(function (target) { return _this.target = target; }).trigger(), queriedElementsWatcher.connect(_this.reset.bind(_this)));
        });
        return _this;
    }
