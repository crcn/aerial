...
export const createImmutableStructFactory = <T>(type: string, defaults?: Partial<T>) => idd(typed(type, (props: Partial<T>) => mapImmutable(defaults, createImmutableObject(props))));
